...
const pages = ['bookhotel', 'bookarestaurant', 'Logout'];
                    ...
                    <Box sx={{ flexGrow: 0 }}>
                        <Tooltip title="Open settings">
                            <IconButton onClick={handleOpenUserMenu} sx={{ p: 0 }}>
                                ...
                                {/* Add the Avatar component inside the IconButton */}
                                <Avatar
                                    src="https://example.com/avatar-image.jpg" // Replace with your avatar image URL
                                    alt="User Avatar"
